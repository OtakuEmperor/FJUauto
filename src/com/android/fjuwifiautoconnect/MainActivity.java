...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(wiFiManager.isWifiEnabled()) {
			wifiManager_button.setText("----關閉WiFi----");
		}
	...
	Runnable runnable = new Runnable() {
		public void run() {
			...
			try {
				...
				Log.i("Main", result);
				showNotification("已成功連線！");
				
			}
			catch(Exception e) {
				Log.e("Main", "error:" + e.toString());
				showNotification("連線失敗！" + " errorMessenger:"+ e.getMessage());
			}
	...
	protected void showNotification(String msg) {
		...
		barMsg.setLatestEventInfo(MainActivity.this, "輔大Wifi君", msg, contentIntent);
	...
	protected void wifiManager() {
		...
		if (!wiFiManager.isWifiEnabled()) {
			...
			wifiManager_button.setText("----開啟WiFi----");
		}
	}
